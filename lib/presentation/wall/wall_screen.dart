...
class WallScreenConsumer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    List<ObjColors> listOfColorsAndsvgs = [
      ObjColors(cardColor: Color(0xFFEEC0C0), svgImage: AssetConstants.bromine),
      ObjColors(cardColor: Color(0xFFC3E0C3), svgImage: AssetConstants.dinosaur),
            ...
            body: Padding(
              ...
              child: Column(
                  ...
                  children: [
                    ...
                    Expanded(child: state.isLoading ? const Center(
                        child: CircularProgressIndicator(),
                      ) : state.ListOfTopics.isEmpty ? Center(
                            ...
                            separatorBuilder: (ctx, i) {
                                    ...
                                    itemBuilder: (ctx, i) {
                                      ...
                                      if(mainIndex< state.ListOfTopics.length){
                                        return UpcomingTopicCard(name: state.ListOfTopics[i].name, 
                                        description: state.ListOfTopics[i].description, svgImage: listOfColorsAndsvgs[i].svgImage, 
                                        color: listOfColorsAndsvgs[i].cardColor, 
                                        );
                                      }else {
                                          return Container(
                                            color: Colors.red,
