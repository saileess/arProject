...
class PlanetsDetailScreen extends StatelessWidget {
  ...
  const PlanetsDetailScreen({Key? key, required this.planetID}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
        create: (context) =>
            PlanetDetailsBloc(PlanetDetailsState.initial(appStateNotifier: appStateNotifier, planetID: planetID))..add(const PlanetDetailsEvent.onLoad()),
                    ...
                    child: state.isLoading
                        ...
                        : state.planetDto == null
                            ...
                            : PlanetDetailsContainer(
                                ...
                                state: state,
                                onToggleBookmark: (){context.read<PlanetDetailsBloc>().add(const PlanetDetailsEvent.onClickBookmark());},
                                )),
          ],
        );
...
class PlanetDetailsContainer extends StatelessWidget {
  ...
  final String title;
  PlanetDetailsContainer(
      {Key? key, required this.imageUrl, required this.detailedPara, required this.title,  this.onToggleBookmark, required this.state})
      : super(key: key);
              ...
              children: [
                ...
                Padding(
                  ...
                  child: GestureDetector(
                    ...
                    child: state.isUpdatingBookmark? SizedBox(height: 5.w,width: 5.w, child: const CircularProgressIndicator(),) :  Icon(Icons.bookmark_border_outlined, color: state.isBookmark? Colors.red: Theme.of(context).colorScheme.tertiary,
                    size: 3.h,),
                  ),
                )
              ],
